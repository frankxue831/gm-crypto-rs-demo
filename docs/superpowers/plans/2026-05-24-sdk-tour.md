...
```bash
/Users/fengxiang/.cargo/bin/cargo test
```
...
```bash
/Users/fengxiang/.cargo/bin/cargo test --test cli
```
...
```bash
/Users/fengxiang/.cargo/bin/cargo test --examples
```
...
```bash
/Users/fengxiang/.cargo/bin/cargo fmt
```
...
```bash
/Users/fengxiang/.cargo/bin/cargo run --quiet -- tour
```
